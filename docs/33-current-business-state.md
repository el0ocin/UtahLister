...
- KSL copy
- recommended cover photo and image order
- buyer reply prompts
- optional guided posting support

The seller keeps the account, the item, and the payout.
...
- Human QC standards are defined.
- Posting rules are defined.
- Buyer reply handling is defined.
- Trial-run and proof-capture logic are defined.
...
UtahLister also has private build work that is intentionally not tracked here as code.

At a business level, that private build includes:

- private operator tooling for photo QC and photo enhancement
- private listing-copy tooling
- private batch-processing and review workflows
- private runtime and local operating setup

Those systems are summarized in [36-private-build-and-systems-summary.md](36-private-build-and-systems-summary.md), but their code and runtime details stay outside this repo.
...
- fully mature lead pipeline
- enough customer proof to treat the business as validated
- a production-ready internal software platform

## Best Way To Read The Business

If you want the cleanest understanding of UtahLister in order:

1. [25-founder-start-here.md](25-founder-start-here.md)
2. [01-offer-and-pricing.md](01-offer-and-pricing.md)
3. [03-service-workflow.md](03-service-workflow.md)
4. [19-marketplace-posting-operating-model.md](19-marketplace-posting-operating-model.md)
5. [34-business-roadmap-and-next-90-days.md](34-business-roadmap-and-next-90-days.md)
6. [36-private-build-and-systems-summary.md](36-private-build-and-systems-summary.md)
7. [37-launch-readiness-summary.md](37-launch-readiness-summary.md)
