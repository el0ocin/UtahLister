# UtahLister Docs Index

This folder is the main handbook for understanding the UtahLister business.

Use it to understand what UtahLister is, how the service works, how the business is meant to grow, and what has already been built privately versus what is intentionally kept out of this public-safe repo.
...
- [37-launch-readiness-summary.md](37-launch-readiness-summary.md)
...
## Offer, Delivery, And Operations

- [01-offer-and-pricing.md](01-offer-and-pricing.md)
- [03-service-workflow.md](03-service-workflow.md)
- [05-pricing-checklist.md](05-pricing-checklist.md)
- [06-human-qc-checklist.md](06-human-qc-checklist.md)
- [07-posting-checklist.md](07-posting-checklist.md)
- [08-buyer-message-bank.md](08-buyer-message-bank.md)
- [14-security-privacy-baseline.md](14-security-privacy-baseline.md)
- [23-trial-run-checklist.md](23-trial-run-checklist.md)

## Growth, Website, And Outreach

- [10-outreach-scripts.md](10-outreach-scripts.md)
- [17-homepage-research-brief.md](17-homepage-research-brief.md)
...
- [00-repo-system.md](00-repo-system.md)
- [12-research-engine.md](12-research-engine.md)
...
- [25-founder-start-here.md](25-founder-start-here.md)
- [29-beginner-founder-handbook.md](29-beginner-founder-handbook.md)

## Public-Safe Repo Rule

This docs set is meant to be safe for a public business repository.

That means the repo should explain:

- what UtahLister is
- how the service works
- where the business is in the build
- what the roadmap looks like

It should not expose:

- source code
- private tooling internals
- customer data
